...
function parensValid(str) {
    ...
    for (let char of str) {
        ...
        if (char === ")") unmatchedOpens--
        if (unmatchedOpens < 0) return false // if we see a close before an open, this will return false
    }
    return unmatchedOpens === 0; // if it's 0, all have been matched and this will return true, otherwise it will return false
}
